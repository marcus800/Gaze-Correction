...
def run():
    ...
    while done:
        ...
        if val == 1:
            ...
            frame2 = colourCorrectAndFrameBlend(frame,box,bigbox)
        else:
            frame2 = frame
...
def colourCorrectAndFrameBlend(frame,eyecords,bigcords):
    frame = frame.copy()
    for i in range(1):
        #Only doing bigEye
        eyeCord = eyecords[i]
        ...
        #Trying Blending just eye section:
...
def linearBlending(frame,correctedeye,Fmask,mask,box):
